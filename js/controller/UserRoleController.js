app.controller("UserRoleController", function ($scope, $controller,IUserRoleService) {
    ...
    $scope.windownInfo.title = "用户角色管理";
     ...
     * */
        ...
        IUserRoleService.findOne(id).then(function (response) {
     ...
     * **/
        ...
        if ($scope.entity.id != null) {
            serviceObject = IUserRoleService.update($scope.entity);
        } else {
            serviceObject = IUserRoleService.add($scope.entity);
        }
     ...
     * */
        ...
        IUserRoleService.delete($scope.selectIds).then(function (response) {
